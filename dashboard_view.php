            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="col-lg-3 col-xs-6">
                  <div class="small-box" style="background:#78a2cc">
                    <div class="inner">
                ...
                <div class="col-lg-3 col-xs-6">
                   <!--small box-->
                  <div class="small-box " style="background:#88aed0">
                    <div class="inner">
                      <h3><?= $count_buku;?></h3>
                ...
                <div class="col-lg-3 col-xs-6">
                  <!-- small box -->
                  <div class="small-box" style="background:#96b9d0">
                    <div class="inner">
                      <h3><?= $count_pinjam;?></h3>
                ...
                <div class="col-lg-3 col-xs-6">
                  <div class="small-box " style="background:#a4c3d2">
                    <div class="inner">
                      <h3><?= $count_kembali;?></h3>
