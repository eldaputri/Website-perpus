					...
					<div class="box box-primary" >
						...
						<div class="box-body">
							...
							<form method="post" action="<?= base_url('data/katproses');?>">
								...
								<input type="text" name="kategori"  value="<?=$kat->nama_kategori;?>" id="kategori" class="form-control"  placeholder="Contoh : Horor" >
							...
							<form method="post" action="<?= base_url('data/katproses');?>" >
								<div class="form-group">
								<label for="">Nama Kategori</label>
								<input type="text" name="kategori" id="kategori" class="form-control" placeholder="Contoh : Horor" >
							...
							<table id="example1" class="table table-bordered table-striped table" width="100%">
								...
								<?php $no=1;foreach($kategori->result_array() as $isi){?>
									<tr>
										...
										<td style="width:20%;">
											<a href="<?= base_url('data/kategori?id='.$isi['id_kategori']);?>"><button class="btn btn-success"><i class="fa fa-edit"></i>Edit</button></a>
