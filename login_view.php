...
<div class="login-box">
  ...
  <div class="login-logo">
    <a href="index.php" style="color: White;"><b>SILAHKAN<br> LOGIN</b></a>
  </div>
  <div id="tampilalert"></div>
  <!-- /.login-logo -->
  <div class="login-box-body" style="border:2px solid #000000;">
    ...
    <form action="<?= base_url('login/auth');?>" method="POST">
      ...
      <div class="row">
        ...
        <div class="col-xs-4">
          <button type="submit" id="loding" class="btn btn-primary btn-block btn-flat bg-black">Sign In</button>
