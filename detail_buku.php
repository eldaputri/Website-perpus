					...
					<table class="table table-striped table-bordered">
						...
						<tr>
							...
							<td><?php if(!empty($buku->sampul !== "0")){?>
									<a href="<?= base_url('assets_style/image/buku/'.$buku->sampul);?>" target="_blank">
										<img src="<?= base_url('assets_style/image/buku/'.$buku->sampul);?>" style="width:250px;height:250px;" class="img-responsive">
									</a>
						...
						<tr >
							...
							<td><?php if(!empty($buku->lampiran !== "0")){?>
									<a href="<?= base_url('assets_style/image/buku/'.$buku->lampiran);?>"> <button type="button" class="btn btn-default pull-right" data-dismiss="modal" style="background:#198FD4 ; color : white;">
										<i class="fa fa-download"></i> Sample Buku </button>
									</a>
